...
def find_employee_by_id():
    id_ = input("Enter id of employee: ")
...
def create_employee():
    ...
    input_department_id = input('Enter employee\'s department id: ')
    try:
        department_id = int(input_department_id)
...
def update_employee():
    ...
    if employee :=Employee.find_by_id(id_):
        try:
            ...
            input_department_id = input("Enter the employees\'s new department id: ")
            department_id = int(input_department_id)
